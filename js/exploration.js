...
const SCENES = {
    ...
    docks: {
        ...
        objects: [
            { type: 'crane', x: 15 },
            { type: 'building', x: 80, h: 45, w: 10, color: 'rgba(255,140,0,0.12)' },
            { type: 'sign', x: 50, text: 'DOCK_07', color: '#ff8c00' },
        ],
    },
    ghost: {
        title: 'GHOST QUARTER',
        ...
        npcX: 65,
        objects: [
            { type: 'building', x: 12, h: 55, w: 5, color: 'rgba(191,95,255,0.1)' },
            { type: 'building', x: 82, h: 65, w: 6, color: 'rgba(191,95,255,0.08)' },
            { type: 'sign', x: 40, text: 'GHOST_NET', color: '#bf5fff' },
        ],
    },
    bazaar: {
        title: 'CHROME BAZAAR',
        ...
        npcX: 60,
        objects: [
            { type: 'stall', x: 30, color: '#f5c518' },
            { type: 'stall', x: 50, color: '#ff8c00' },
            { type: 'sign', x: 20, text: 'MOD_SHOP', color: '#f5c518' },
            { type: 'sign', x: 70, text: 'IMPLANTS', color: '#ff8c00' },
        ],
    },
    slums: {
        title: 'NEURAL SLUMS',
        ...
        npcX: 72,
        objects: [
            { type: 'building', x: 8, h: 40, w: 6, color: 'rgba(255,45,120,0.1)' },
            { type: 'building', x: 88, h: 50, w: 7, color: 'rgba(255,45,120,0.08)' },
            { type: 'sign', x: 45, text: 'ZONA_X', color: '#ff2d78' },
        ],
    },
    bridge: {
        title: 'SKYBRIDGE',
        ...
        npcX: 68,
        objects: [
            { type: 'sign', x: 30, text: 'SKY_LN', color: '#00aaff' },
        ],
    },
    helix: {
        title: 'HELIX LAB',
        ...
        npcX: 74,
        objects: [
            { type: 'building', x: 10, h: 80, w: 12, color: 'rgba(57,255,20,0.08)' },
            { type: 'building', x: 78, h: 70, w: 10, color: 'rgba(57,255,20,0.06)' },
            { type: 'sign', x: 45, text: 'HELIX_R&D', color: '#39ff14' },
        ],
    },
    blackout: {
        title: 'BLACKOUT ZONE',
        ...
        npcX: 78,
        objects: [
            { type: 'sign', x: 50, text: 'NO_SIGNAL', color: '#ff4444' },
        ],
    },
};
