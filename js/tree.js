                ...
                choices: [
                    {
                        ...
                        choices: [],
                        effects: { time: 1, credits: -150, health: 0 },
                ...
                choices: [
                    {
                        ...
                        choices: [],
                        effects: { time: 1, credits: -500, health: 0 },
                ...
                choices: [
                    {
                        ...
                        choices: [],
                        effects: { time: 1, credits: -600, health: 0 },
                        unlocks: [],
                        locks: [],
                ...
                choices: [
                    {
                        ...
                        choices: [],
                        effects: { time: 1, credits: -200, health: 0 },
                        unlocks: [],
                        locks: [],
    ...
    bridge: {
        ...
        choices: [
            ...
            },
            {
                ...
                choices: [],
                effects: { time: 1, credits: -350, health: 0 },
                unlocks: [],
                locks: [],
                nextDistricts: ['ghost', 'bazaar', 'slums'],
            },
    ...
    helix: {
        ...
        choices: [
                ...
                choices: [
                    {
                        ...
                        choices: [],
                        effects: { time: 1, credits: 0, health: -20 },
                        unlocks: [],
                        locks: [],
            ...
            },
            {
                ...
                choices: [],
                effects: { time: 1, credits: -100, health: 0 },
                unlocks: [],
                locks: [],
                nextDistricts: ['blackout'],
            },
